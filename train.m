...
train_data = 'D:\datasets\rellis_3D\Rellis-3D\combine_img';
...
%%
down_img = imageDatastore('C:\Users\max\Documents\MATLAB\vipr\Capture.PNG')
...
B = labeloverlay(I,C,'Colormap',cmap,'Transparency',0.999);
%B = imerode(B,se);
%B = imerode(B,se);
%B = imdilate(B,se);
%B = imdilate(B,se);
