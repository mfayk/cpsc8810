...
void your_kmeans(int rows, int cols, int numclasses, int *predictions, std::vector<float> *centroids, uchar4 *h_img, int max_its);
void your_kmeans_shared(int rows, int cols, int numclasses, int *predictions, std::vector<float> *centroids, uchar4 *h_img, int max_its);
